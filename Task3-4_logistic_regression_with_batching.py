...
def train_with_batchsize(batch_size, epochs=EPOCHS, lr=0.001):
    losses = []
    ...
    for epoch in range(epochs):
        ...
        for b in range(n_batches):
            ...
            X_batch = X_train_shuffled[start:end].T  # (2, batch_size)
            y_batch = y_train_shuffled[start:end].reshape(1, -1)  # (1, batch_size)
            ...
            epoch_loss += loss.value / batch_size  # average per sample
...
for bs in batch_sizes:
    ...
    all_losses[bs] = train_with_batchsize(bs, epochs=EPOCHS, lr=0.001)
